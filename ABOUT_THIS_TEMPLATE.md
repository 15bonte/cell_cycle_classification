...
├── cell_cycle_classification             # The main python package for the project
...
e.g: `cat cell_cycle_classification/VERSION` will get the project version without harming
